                ...
                <Row>
                    <Col md={3}>
                        <table className="table table-sm border shadow-sm bg-light">
                            <thead>
                                <tr>
                                    <th colSpan="2" className="bg-success text-light text-center" style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>Available Agent</th>
                                </tr>
                            </thead>
                            <tbody>
                    ...
                    <Col md={3}>
                        <table className="table table-sm border shadow-sm bg-light">
                            <thead>
                                <tr>
                                    <th colSpan="2" className="bg-info text-light text-center" style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>Active Agent</th>
                                </tr>
                            </thead>
                            <tbody>
                                {
                    ...
                    <Col md={3}>
                        <table className="table table-sm border shadow-sm bg-light">
                            <thead>
                                <tr>
                                    <th colSpan="2" className="bg-warning text-center" style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>Wrap Agent</th>
                                </tr>
                            </thead>
                            <tbody>
                                {
                    ...
                    <Col md={3}>
                        <table className="table table-sm border shadow-sm bg-light">
                            <thead>
                                <tr>
                                    <th colSpan="2" className="bg-danger text-light text-center" style={{ fontSize: '1.5rem', fontWeight: 'bold' }}>Not Ready Agent</th>
                                </tr>
                            </thead>
                            <tbody>
                                {
